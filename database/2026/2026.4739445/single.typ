...
与此同时，科研诚信本身也正在从一个专业性的内部问题逐渐进入公众视野。2026 年，中国视频博主"耿同学"（Geng Hongwei）通过公开分析已发表论文，指出其中可能存在的数据异常与图像重复问题，并由此推动多所高校展开调查。Nature 与 Science 分别对此进行了专题报道；Nature 报道称，在相关质疑引发的调查之后，已有多名资深学者受到处分。#cite(<You2026StudentGeng>, <Normile2026MisconductSleuth>) 一个过去往往只能通过同行评议、期刊编辑和机构调查完成的科研诚信审查过程，由此第一次如此鲜明地进入公共传播空间。
